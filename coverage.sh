...
if [ "$CMD" = "install" ]; then
    ...
    echo "    libcurl4-openssl-dev libelf-dev libdw-dev cmake gcc binutils-dev zlib1g-dev libiberty-dev"
    ...
    sudo apt-get -y install libcurl4-openssl-dev libelf-dev libdw-dev cmake gcc binutils-dev zlib1g-dev libiberty-dev
